...
This project is intendend for study and personal development in software engineering.

The main goal is to create a system that is mutable over time; it's starting as a simple CRUD, but will evolve over time.
